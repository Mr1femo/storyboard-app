  ...
  <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-brand-soft via-white to-orange-50 px-4">
    <div class="w-full max-w-md">
      ...
      <div class="text-center mb-8">
        ...
        <h1 class="text-3xl font-extrabold text-gray-900 font-display tracking-tight">
          Raccoon
        </h1>
        <p class="text-brand font-semibold text-sm mt-1 font-display italic">
          Ideas like a Raccoon!
        </p>
        <p class="text-gray-500 text-sm mt-4">
          Welcome to the Raccoon Client Portal
        </p>
        <p class="text-gray-400 text-xs mt-1">
          Design · Video · Copywriting — all in one place
        </p>
      </div>
      ...
      <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
        ...
        <p class="text-xs text-gray-400 text-center mt-6">
          Admin or client — use credentials provided by Raccoon
        </p>
      </div>

      <p class="text-center text-xs text-gray-400 mt-6">
        Powered by Raccoon — Ideas like a Raccoon!
      </p>
    </div>
  </div>
</template>
